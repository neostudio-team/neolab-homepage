    ...
    <FooterRoot>
      <Inner>
        <TopGrid>
          ...
          <Col>
            <FollowTitle>{dict.follow}</FollowTitle>
            <SocialRow>
              <SocialLink
            ...
            <LanguageSwitcher lang={lang} variant="footer" separator={<span>|</span>} />
          </Col>
        </TopGrid>
        ...
        <BottomBar>
          <BottomRow>
            ...
            <LegalRow>
              {lang === "ko" && (
                <>
                  <LegalLink href="/ko/privacy">개인정보처리방침</LegalLink>
                  <Divider>|</Divider>
                  <LegalLink href="/ko/terms">이용약관</LegalLink>
                  <Divider>|</Divider>
                </>
              )}
