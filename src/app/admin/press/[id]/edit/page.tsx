      ...
      {showModal ? (
        <AdminModalOverlay>
          <AdminConfirmModal>
            ...
            <AdminModalTitle>기업뉴스 수정</AdminModalTitle>
            ...
            <tbody>
              <tr>
                ...
                <AdminFormValueCell>
                  <AdminFlexRowWrap>
                    <AdminFlexGap2>
                      <AdminMutedSmall as="label" htmlFor={`press-edit-category-${id}`}>
                        카테고리
                      </AdminMutedSmall>
                      <AdminInput
                        id={`press-edit-category-${id}`}
                        value={form.category}
                        onChange={(e) => setField("category", e.target.value)}
                      />
                    </AdminFlexGap2>
                    <AdminFlexGap2>
                      <AdminMutedSmall as="label" htmlFor={`press-edit-author-${id}`}>
                        작성자
                      </AdminMutedSmall>
                      <AdminInput
                        id={`press-edit-author-${id}`}
                        value={form.author}
