      ...
      {showModal ? (
        <AdminModalOverlay>
          <AdminConfirmModal>
            ...
            <AdminModalTitle>공지사항 수정</AdminModalTitle>
              ...
              <tr>
                ...
                <AdminFormValueCell>
                  <AdminFlexGap6>
                    ...
                    <AdminFlexGap6>
                      <AdminMutedSmall as="label" htmlFor={`notice-edit-author-${id}`}>
                        작성자
                      </AdminMutedSmall>
                      <AdminInput
                        id={`notice-edit-author-${id}`}
                        value={form.author}
