  ...
  useEffect(() => {
    fetch(`/api/notices/${id}`).then(r => r.json()).then(data => {
      setForm({
        ...
        author: data.author ?? "NeoLAB", tags: data.tags ?? "",
      ...
      {showModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40">
          <div className="bg-white rounded-2xl shadow-xl p-8 w-[360px] flex flex-col items-center gap-5">
            ...
            <h2 className="text-lg font-bold text-gray-800">공지사항 수정</h2>
          ...
          <table className="w-full text-sm">
            <tbody>
              ...
              <tr className="border-b border-gray-100">
                ...
                <td className="px-5 py-3">
                  <input value={form.titleKo} onChange={(e) => set("titleKo", e.target.value)} required placeholder="공지사항 제목"
