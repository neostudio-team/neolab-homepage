...
import {
  ...
  SplitTitle,
  SysReq,
} from "../../neosmartpen/penmanager/PenManagerPage.styles";
    ...
    <>
      ...
      <main>
        ...
        <GraySection>
          <Container>
            <Split>
              <Half><GifImage src={`${IMG}/gridaboard_usage_01.gif`} alt="Grida board usage" /></Half>
              <Half>
                <SplitTitle>{t.s2.title}</SplitTitle>
                <SplitSub>{t.s2.subtitle}</SplitSub>
                <DarkBtn href="https://gridaboard.io/" target="_blank" rel="noopener noreferrer">{t.s2.cta}</DarkBtn>
                <Note>{t.s2.note}</Note>
              </Half>
            </Split>
          </Container>
          ...
          <Container>
            <CtaSplit>
              ...
              <CtaText>
                ...
                <DarkBtn href={lang === "ko" ? "https://store.neosmartpen.com/" : lang === "ja" ? "https://neosmartpenjp.com/" : "https://shop.neosmartpen.com/"} target="_blank" rel="noopener noreferrer">{t.s3.cta}</DarkBtn>
              </CtaText>
            </CtaSplit>
          </Container>
        </CtaSection>
